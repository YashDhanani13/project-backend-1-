...
exports.deleteEmployee = exports.updateEmployee = exports.getSearch = exports.getEmployee = exports.createEmployee = void 0;
...
const getSearch = async (req, res) => {
    try {
        ...
        const result = await employeeService.getEmployee(search);
        res.status(200).json({
            success: true,
